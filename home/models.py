...
class Order(models.Model):
    ...
    smart_contract_address = models.CharField(max_length=50)
    start_date = models.CharField(max_length=12)



class EtherAccountCustomer(models.Model):
    customer = models.ForeignKey(User, on_delete=models.CASCADE)
    address = models.CharField(max_length=50)
    private_key = models.CharField(max_length=70)

class EtherAccountCarDealer(models.Model):
    car_dealer = models.ForeignKey(CarDealer, on_delete=models.CASCADE)
    address = models.CharField(max_length=50)
    private_key = models.CharField(max_length=70)

class TX_history(models.Model):
